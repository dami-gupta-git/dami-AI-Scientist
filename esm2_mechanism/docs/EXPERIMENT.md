...
**Local copy:** `templates/esm2_mechanism/run_0/data/DiseaseMech_Stability_VEPS.xlsx` (233MB, gitignored). Sheet used: `HGMD_four_class`. SCP to new pods rather than re-downloading from OSF.
