...
- Results: `templates/esm2_mechanism/run_0/final_info_seed0.json`
- Detailed: `templates/esm2_mechanism/run_0/detailed_results_seed0.json`
- Embeddings: on RunPod (regenerate in ~5-10 min with optimized code)
- Cached data: `run_0/data/` — sequences.json, pfam_families.json, alphamissense_scores.json, gerasimavicius_variants.json
