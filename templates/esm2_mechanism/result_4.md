...
**Date:** 2026-05-24
**Run:** `run_0/`, model `esm2_t33_650M_UR50D`
**Script:** `family_clustering.py`
**Output:** `run_0/family_clustering.json`
...
- `family_clustering.py` — analysis script (~310 lines, reuses `experiment.py` helpers)
- `run_0/family_clustering.json` — full metric output, all three views
